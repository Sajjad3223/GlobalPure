<template>
  <div class="w-full flex flex-col gap-2">
    ...
    <textarea v-else rows="5" @change="updateData" :placeholder="placeholder" :name="name" :id="name" class="bg-[#FFFDF6] border border-[#493E17] px-4 py-2 2xl:py-4 placeholder-[#493E17]/50 text-[#493E17]" :required="required"></textarea>
  </div>
</template>
